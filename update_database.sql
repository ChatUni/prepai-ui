...
-- Update courses table with instructor_id
UPDATE courses SET instructor_id = (SELECT id FROM instructors WHERE name = '陈浩老师') WHERE instructor = '陈浩老师';
UPDATE courses SET instructor_id = (SELECT id FROM instructors WHERE name = '子森') WHERE instructor = '子森';
